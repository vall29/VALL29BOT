...
* HARGAILAH PEMBUAT SCRIPT INI BOSQ
* JANGAN UBAH-UBAH INFO!!!
* @RIVALFDLA
* BOLEH UBAH TAPI KECUALI INFO!!!
*/
const A187 = '👾VALL29BOT👾'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/rivalfdla'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+6285830092151'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung jaringan'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'https://chat.whatsapp.com/EpMBlLhGl922shCyNEljDb'; // JANGAN UBAH-UBAH INFO!!!
const youtube = 'https://www.youtube.com/channel/UCTMkK0oTTBrFvIwUHS1Dodw'; // JANGAN UBAH-UBAH INFO!!!
//A187ID
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] VALL29BOT ready scan now!`);
});
...
conn.sendMessage(id, ' *Owner VALL29BOT wa.me/+6285830092151* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Creator VALL29BOT wa.me/+6285830092151* ' ,MessageType.text);
}
else if (text == 'Pagi'){
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾VALL29BOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/rivalfdla' ,MessageType.text);
}
else if (text == '#menu1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾VALL29BOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/rivalfdla' ,MessageType.text);
}
